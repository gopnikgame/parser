...
main_menu() {
    while true; do
        ...
        # Принудительно выводим меню без функции log()
        echo ""
        echo "=========================================================="
        echo "🔍 DNSCrypt Parser v2.0 with Modular System & Scheduler"
        echo "=========================================================="
        echo ""
        echo "1. ⬆️  Обновить из репозитория"
        echo "2. 📝 Создать или редактировать .env файл"
        echo "3. 🔑 Проверить GitHub токен"
        echo "4. 🔍 Проверить модульную систему"
        echo "5. ⏰ Запустить scheduler (автоматические обновления)"
        echo "6. ⏹️  Остановить scheduler"
        echo "7. 📊 Статус scheduler'а"
        echo "8. 🔄 Перезапустить scheduler"
        echo "9. ⏰ Сбросить таймер scheduler'а"
        echo ""
        echo "🚀 ЗАПУСК ПАРСЕРА:"
        echo "10. 🔄 Запустить парсер (авто-выбор)"
        echo "11. 🚀 Запустить модульный парсер v2.0"
        echo ""
        echo "📋 ПРОСМОТР И УПРАВЛЕНИЕ:"
        echo "12. 📋 Просмотреть логи"
        echo "13. 📊 Просмотреть результаты парсинга"
        echo "14. 🧹 Очистить старые логи"
        echo "15. 🐳 Очистить Docker"
        echo "16. 🔧 Проверить и исправить установку Docker"
        echo ""
        echo "0. 🚪 Выйти"
        echo ""
        ...
        case "$choice" in
            ...
            0)
                ...
                ;;
            *)
                echo "❌ Неверный выбор. Пожалуйста, выберите действие от 0 до 16."
                ;;
        esac
...
init() {
    echo "🚀 Инициализация DNSCrypt Parser Manager..."
